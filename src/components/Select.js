       ...
       <>
        <section className="flex justify-center py-0.5 ">
            <div className="py-4 bg-gray-50 px-5 rounded">
                ...
                <select onChange={handleChange} value={value} className=" border border-slate-300 rounded w-12/12 p-1 focus:outline-none focus:border-gray-400 focus:ring-1 focus:ring-gray-400" name="cities" id="city-select">
