            ...
            <section className="flex justify-center py-0.5 text-center">
                <div className="py-4 bg-transparent px-5 rounded ">
                    ...
                    <select
                        ...
                        value={value}
                        className=" border bg-gray-800 text-gray-200 border-slate-300 rounded-lg w-12/12 p-1 focus:outline-none focus:border-gray-400 focus:ring-1 focus:ring-gray-400"
                        name="cities"
                        id="city-select"
                    >
